...
class TestAssignmentNotebook(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.global_env = {"display": display}  # ✅ Make display available
        
        for cell in nb.cells:
            if cell.cell_type == "code":
                exec(cell.source, cls.global_env)  # ✅ Now display() will work
    ...
    def test_dataframe_columns(self):
        ...
        required_columns = {"Name", "Age", "Salary"}  # ✅ Change "Score" to "Salary"
